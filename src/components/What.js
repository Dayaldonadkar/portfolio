...
const What = () => {
  return (
    <div
      ...
      id="what"
    >
      <div className="w-[90%] lg:w-[90%] xl:w-[78%] 2xl:w-[70%] lg:px-5 lg:grid-cols-2 md:pb-10 md:py-5">
        ...
        <div className="flex justify-center">
          <div className="space-y-5 w-[90%] my-5 md:grid md:grid-cols-2 md:space-y-0 md:gap-y-4">
            {whatdata.map((user, index) => {
              return (
                <div
                  key={index}
                  className="px-4 py-3 text-[#909090] space-x-3 flex items-center bg-[#FFFFFF] rounded-lg md:mr-5 lg:py-6"
                >
