...
const About = () => {
  return (
    <div className="flex justify-center font-montserrat bg-[#]">
      <div className="w-[90%]  md:w-[85%] xl:w-[75%] 2xl:w-[65%] lg:flex lg:justify-between lg:items-center">
        ...
        <div className="lg:w-1/2">
          ...
          <div className="flex justify-center md:justify-start">
            <p className="text-sm md:text-left mb-10 text-[#909090] py-3 w-[95%] lg:w-[100%] flex justify-center">
